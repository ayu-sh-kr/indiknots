...
<template>
    <input
        ...
        class="text-lg md:text-xl dark:bg-slate-600 border border-gray-200 dark:border-gray-800 focus:outline-none focus:ring-4 focus:ring-orange-300 dark:focus:ring-orange-500 py-2 px-3 w-full rounded-md"
        :class="`${processState()}`"
        @input="updateValue"
    >
</template>
