...
const items: FAQ[] = [
...

    {
        ...
        content: `
        <p>Once you place your order, we'll send you a confirmation email and WhatsApp message. When your order ships, we’ll send another email with tracking information and a receipt of invoice.</p>
        `
    },
